...
const AddNewAddressView = ({
  ...
  return (
    <Box display="flex" flexDirection="column">
      ...
      />
      <span class='material-icons-outlined'><HistoryToggleOff/></span>
...
const Checkout = () => {
  ...
  const addAddress = async (token, newAddress) => {
    try {
      ...
      let urlAddress = `${config.endpoint}/user/addresses`;
   ...
   *
   */
  // here we are using validate request to validate condtion
